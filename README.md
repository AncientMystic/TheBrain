...
<table>
<tr>
<td width="50%" align="center"><img src="https://github.com/AncientMystic/TheBrain/blob/main/ScreenShots/Dashboard.JPG?raw=true" alt="Dashboard tab" width="100%"><br><em>Dashboard tab — Displays metrix, database sizes, etc </em></td>
